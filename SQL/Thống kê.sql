select id as 'ID', so 'Số hiệu', quyenSo 'Quyển số', ngayDangKy 'Ngày đăng ký', tableName 'Loại', columnName 'Trường', 
...
from Diff where CONVERT(nvarchar(10), ngayCapNhatKTBM1, 103) >= '05/09/2022' 
