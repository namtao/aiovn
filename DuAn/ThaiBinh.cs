...
namespace xD.DuAn
{
    class ThaiBinh
    {
        ...
        public void Errors()
        {
            ...
            {
                using (SqlConnection con = new SqlConnection(@"Data Source=.;Initial Catalog=xD_AnGiang;Integrated Security=True"))
                {
                    string sql = "" +
        ...
        public void ThongKe(string path)
        {
            ...
            //thống kê trường
            SqlConnection sql1 = new SqlConnection(@"Data Source=.;Initial Catalog=xD_AnGiang;Integrated Security=True");
            ...
            using (StreamWriter writer = File.AppendText(txtPath))
            {
                using (SqlConnection con = new SqlConnection(@"Data Source=.;Initial Catalog=xD_AnGiang;Integrated Security=True"))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(sql, con))
                    {
                        ...
                        while (dr.Read())
                        {
                            using (SqlConnection connect = new SqlConnection(@"Data Source=.;Initial Catalog=xD_AnGiang;Integrated Security=True"))
                            {
        ...
        public void ExportData()
        {
            ...
            using (SqlConnection conStr = new SqlConnection(@"Data Source=.;Initial Catalog=xD_AnGiang;Integrated Security=True"))
            {
                string sql = "" +
            ...
            for (int index = 0; index < listProfileName.Count; index++)
            {
                ...
                oBook.SaveAs(@"C:\xD\DA Thái Bình\Excel\" + listProfileName[index] + ".xlsx");
                oBooks.Close();
                oExcel.Quit();
            }
        }
