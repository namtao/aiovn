...
for f in csv_files:
    ...
    # set header
    df_new.columns = ['Số tt','Sổ KHVB','Ngày tháng VB','Trích yếu nội dung','Tác giả văn bản','Tờ số', 'ghi chú']
    ...
    worksheet.conditional_format(xlsxwriter.utility.xl_range(0, 0, len(df_new), len(df_new.columns) - 1), {'type': 'no_errors', 'format': border_fmt})
