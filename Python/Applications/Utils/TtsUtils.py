...
def m3u82mp3(linkm3u8, chaper):
    cmd = 'ffmpeg -allowed_extensions ALL -i '+ linkm3u8 +' -map 0:a -acodec libmp3lame ' + '\"' + chaper + '.mp3\"'
    os.system(cmd)

def getLinkm3u8(text):
