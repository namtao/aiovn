        ...
        for file in files:
            ...
            if pattern.match(file):
                ...
                if(not os.path.exists(os.path.join(output_path, folderName , fileName))):
                    ...
                    shutil.copy(os.path.join(root, file), os.path.join(output_path, folderName , fileName))
                


copy_file_struct(r'D:\BINHDINH\ADDJ_THICONG\Files\000.00.37.H08',r'C:\BinhDinh\AppData\Document')