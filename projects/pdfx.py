...
def merge_jpg_to_pdf():
    images = [
        ...
        Image.open(f)
        for f in [r"C:\Users\ADDJ\Downloads\h01\1976.hss 02\image00001.jpg",
                  r"C:\Users\ADDJ\Downloads\h01\1976.hss 02\image00002.jpg",
                  r"C:\Users\ADDJ\Downloads\h01\1976.hss 02\image00003.jpg"]

    ]

    pdf_path = r"C:\Users\ADDJ\Downloads\h01\1976.hss 02\bbd1.pdf"

    images[0].save(
        pdf_path, "PDF", resolution=300.0, save_all=True, append_images=images[1:]
    )
