        ...
        public void MessagesentHandler(MessageData mData)
        {
            ...
            // In the case of unexpected user disconnection
                   else if (mData.action == NetworkAction.UserDisconnection)
                {
                    ...
                    HistoryListbox.Items.Add(mData.Userdat.Username + " đã ngắt kết nối" + current.ToLongTimeString());
                }
                ...
                {
                    ChatListBox.Items.Add(mData.Userdat.Username + " : " + mData.Textmessage);
                }
            }
        }
