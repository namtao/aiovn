    ...
    public partial class Home : Form
    {
        ...
        public void xuLy()
        {
            if (tabControl.SelectedIndex == 0)
            {
                ...
                string sqlQuery = "select RIGHT(quyenSo, 4) as N'Năm', noiDangKy as N'Mã nơi đăng ký',  REPLACE(REPLACE(REPLACE(REPLACE(TenNoiDangKy, N'UBND ', ''),N', thành phố hồ chí minh',''),N'phường','P.'),N'Quận', 'Q') as N'Tên nơi đăng ký', " +
