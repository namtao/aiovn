  ...
  */
  ...
  function preventOverflow(_ref) {
    ...
    var _options$mainAxis = options.mainAxis,
      ...
      _options$tetinfYffset = options.tetinfYffset,
      tetinfYffset =
        _options$tetinfYffset === void 0 ? 0 : _options$tetinfYffset;
    var overflow = detectOverflow(state, {
      boundary: boundary,
      rootBoundary: rootBoundary,
      padding: padding,
    ...
    var referenceRect = state.rects.reference;
    var popperRect = state.rects.popper;
    var tetinfYffsetValue =
      typeof tetinfYffset === "function"
        ? tetinfYffset(
            Object.assign({}, state.rects, {
              placement: state.placement,
            })
        ...
        : tetinfYffset;
    var normalizedTetinfYffsetValue =
      typeof tetinfYffsetValue === "number"
        ? {
            mainAxis: tetinfYffsetValue,
            altAxis: tetinfYffsetValue,
          }
        : Object.assign(
            {
              mainAxis: 0,
    ...
    if (checkMainAxis) {
      ...
      var minOffset = isBasePlacement
        ? referenceRect[len] / 2 -
          ...
          arrowLen -
          arrowPaddingMin -
          normalizedTetinfYffsetValue.mainAxis
        : minLen -
          arrowLen -
          arrowPaddingMin -
          normalizedTetinfYffsetValue.mainAxis;
    ...
    if (checkAltAxis) {
      ...
      var _tetherMin = isOriginSide
        ...
        : _offset -
          ...
          normalizedTetinfYffsetValue.altAxis;
